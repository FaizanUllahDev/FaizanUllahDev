# 👋 Hello, I'm Faizan Ullah

### Senior Software Engineer | Mobile & Web Architect | Gold Medalist
I am a **Senior Flutter Developer** with 5+ years of experience specialized in building production-grade mobile applications and AI-driven experiences. Currently, I lead the Flutter engineering for **American Express KSA**, managing the full lifecycle of a secure banking application.

---

### 🏛️ Engineering Philosophy
I am transitioning from "code monkey" implementation to **Architectural Leadership**. I leverage **"Vibe Coding"** to prioritize rapid product creation and user experience architecture, using modern AI tools to handle boilerplate while I focus on system design and distributed systems.
